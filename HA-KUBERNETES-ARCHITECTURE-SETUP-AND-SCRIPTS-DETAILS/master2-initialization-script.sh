...
echo -e "\e[32mFourth Run , Your Kubernetes MASTER2 is waiting , Immediately fire CONTROL_PLANE_JOINING TOKEN as ROOT user , received from MASTER1 Initialization script\e[0m"
